 ...
 * This allows database columns to be mapped to a POJO that adheres to JavaBeans
 * conventions based on a variety of techniques.
 *
...
public interface MappingStrategy {
     ...
     * @param targetObject The target object instance to bind the value to if a
     *                     match is found.
    ...
    /**
     * A {@link MappingStrategy} that depends upon reflection to determine which
    ...
    interface ReflectionBased extends MappingStrategy {
         ...
         * @param fieldNames The target field names to match the column
         *                   against.
         * @return An {@link Optional} instance of the matching property name.
         */
    ...
    /**
     * A MappingStrategy that tries to match automatically overcoming a variety
     * of criteria such as: <ul> <li>letter case ("A" vs. "a")</li> <li>special
     * characters ("_", ".", "-", etc.)</li> </ul>
     * <p>
     * This allows for combinations like the ones below to be matched: <table>
     * <tr> <th>Example Bean Property</th> <th>Example Table Column</th>
     * <th>Notes</th> </tr> <tr> <td>employeeId</td> <td>employeeId</td>
     * <td>Straight-forward match</td> </tr> <tr> <td>employeeId</td>
     * <td>EmployeeID</td> <td>Case difference</td> </tr> <tr>
     * <td>employeeId</td> <td>EMPLOYEE_ID</td> <td>Special characters</td>
     * </tr> </table>
     */
    ...
    /**
     * A MappingStrategy that requires an exact case-sensitive String match
    ...
    /**
     * A MappingStrategy that only requires that field names contain the same
     * letters, regardless of letter case.  If multiple fields on the target
     * object would result in a match, the first field found will be selected.
     */
